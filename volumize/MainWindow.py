...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.toolButton_refreshList = QtWidgets.QToolButton(self.centralwidget)
        self.toolButton_refreshList.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/view-refresh.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.toolButton_refreshList.setIcon(icon1)
        self.toolButton_refreshList.setObjectName("toolButton_refreshList")
        self.horizontalLayout.addWidget(self.toolButton_refreshList)
        ...
        self.pushButton_outputFolder.setIcon(icon2)
